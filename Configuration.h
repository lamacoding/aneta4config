...
#define STRING_CONFIG_H_AUTHOR "Matthias Langwieser (langi4888)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet A4"
...
#define DELTA
  ...
  #define DELTA_RADIUS 111.0 //mm  Get this value from auto calibrate
